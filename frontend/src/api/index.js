...
export const dashboardRegional = (regionalId = null) => 
  regionalId ? api.get(`/dashboard/regional/${regionalId}/`) : api.get('/dashboard/regional/');
export const dashboardVendedor = (vendedorId = null, regionalId = null) => {
  if (vendedorId) {
    return api.get(`/dashboard/vendedor/${vendedorId}/`);
  } else if (regionalId) {
    return api.get(`/dashboard/vendedor/regional/${regionalId}/`);
  }
...
// CRUD endpoints
export const getRegionais = () => api.get('/regionais/');
...
export const createRegional = (data) => api.post('/regionais/', data);
...
export const updateRegional = (id, data) => api.put(`/regionais/${id}/`, data);
...
export const deleteRegional = (id) => api.delete(`/regionais/${id}/`);
