            ...
            <Card key={venda.id} className="venda-card">
              ...
              <CardContent>
                <div className="venda-details">
                  ...
                  {venda.arquivo_pdf && (
                    <div className="venda-actions" style={{ justifyContent: 'flex-start', marginTop: 12, padding: 0, background: 'transparent' }}>
                      <Button
                        variant="outline"
                        size="sm"
            ...
            <div className="modal-content">
              <div className="venda-resumo">
                ...
                <div className="resumo-grid">
                  ...
                  <div className="resumo-item">
                    <Label>Cliente</Label>
                    <span className="text-blue-600 font-bold">{vendaSelecionada.cliente_venda || vendaSelecionada.cliente_nome}</span>
                  </div>
                  <div className="resumo-item">
              ...
              {acao === 'rejeitar' && (
                <div className="motivo-section mt-8">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <Label htmlFor="motivo" className="text-red-700 font-bold uppercase text-xs tracking-wider">Motivo da Rejeição *</Label>
                  </div>
                  <Textarea
                    id="motivo"
              ...
              <div className="modal-actions">
                ...
                >
                  <div className="flex items-center justify-center">
                    ...
                    <span>{submitting ? 'Processando...' : (acao === 'validar' ? 'Confirmar Validação' : 'Confirmar Rejeição')}</span>
                  </div>
                </Button>
              </div>
            </div>
