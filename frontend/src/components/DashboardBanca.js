            ...
            <main className={styles.main}>
                <div className={styles.container}>
                    <div className={styles.tabsContainer}>
                        ...
                        <button
                            className={`${styles.tabButton} ${activeTab === 'regras' ? styles.active : ''}`}
                            ...
                            <div className={styles.statsOverview}>
                                <div className={styles.statCard}>
                                    ...
                                    <div className={styles.statValue}>
                                        R${' '}
                                        {Number(dashboardData?.faturamento_previsto || 0).toLocaleString('pt-BR', {
                                            minimumFractionDigits: 2,
                                        })}
                                    </div>
                                    <div className={styles.statLabel}>Faturamento Previsto Total</div>
                                    <div className={styles.statTrend}>Soma total das propostas validadas</div>
                                </div>
                                ...
                                {dashboardData?.status_sistema === 'pre_workshop' && (
                                    <div className={styles.statCard}>
                                        ...
                                        <div className={styles.statValue}>{dashboardData?.propostas_vendidas || 0}</div>
                                        <div className={styles.statLabel}>Propostas Vendidas</div>
                                        <div className={styles.statTrend}>Propostas validadas e vendidas no Pré-Workshop</div>
                                    </div>
                                )}
                                ...
                                {dashboardData?.status_sistema === 'pos_workshop' && (
                                    <div className={styles.statCard}>
                                        ...
                                        <div className={styles.statValue}>
                                            R${' '}
                                            {Number(dashboardData?.faturamento_realizado || 0).toLocaleString('pt-BR', {
                                                minimumFractionDigits: 2,
                                            })}
                                        </div>
                                        <div className={styles.statLabel}>Faturamento Realizado Total</div>
                                        <div className={styles.statTrend}>Soma total das vendas validadas pelo gestor</div>
                                    </div>
                                )}
                            </div>
                                    ...
                                    <tbody>
                                        {dashboardData?.equipes?.map((equipe, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    {dashboardData?.status_sistema === 'pos_workshop'
                                                        ? equipe.propostas_validadas ||
                                                        equipe.propostas_vendidas_validada ||
                                                        equipe.vendas_concretizadas ||
                                                        0
                    ...
                    {activeTab === 'regras' && <RegrasPontuacao />}
                </div>
            </main>
