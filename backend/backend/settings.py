...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-3s!rrsa6eojb0+s8=$xd7y6jc%911k!!lnk48*(*3zz+@-@$&w')
...
MIDDLEWARE = [
    ...
    'api.middleware.StatusSistemaMiddleware',
    'api.middleware.PermissaoMiddleware',
]
