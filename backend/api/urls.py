...
urlpatterns = [
    ...
    path('dashboard/regional/', views.dashboard_regional, name='dashboard_regional'),
    path('dashboard/regional/<int:regional_id>/', views.dashboard_regional, name='dashboard_regional_especifica'),
    path('dashboard/vendedor/', views.dashboard_vendedor, name='dashboard_vendedor'),
    path('dashboard/vendedor/regional/<int:regional_id>/', views.dashboard_vendedor, name='dashboard_vendedor_regional'),
    ...
    path('banca/regras-bonus/', views.regras_bonus_api, name='regras_bonus_api'),
    path('banca/regras-bonus/<int:pk>/', views.regra_bonus_detail_api, name='regra_bonus_detail_api'),
